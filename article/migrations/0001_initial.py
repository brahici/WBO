...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('article_article', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['article.Category'], on_delete=models.PROTECT)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255)),
            ...
            ('state', self.gf('django.db.models.fields.CharField')(default='draft', max_length=32)),
    ...
    models = {
        'article.article': {
            'Meta': {'ordering': "['-published_date', '-creation_date', '-last_update']", 'object_name': 'Article'},
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['article.Category']", 'on_delete': 'models.PROTECT'}),
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "'draft'", 'max_length': '32'}),
